...
int Bruce::InputDg::PartitionKey::V0::WriteDg(
  ...
  size_t size = 0;
  int ret = input_dg_p_key_v0_compute_msg_size(&size, topic_size, key_size,
      value_size);
  ...
  input_dg_p_key_v0_write_msg(&result_buf[0], timestamp, partition_key,
